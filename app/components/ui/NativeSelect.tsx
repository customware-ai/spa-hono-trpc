...
function NativeSelect({
  ...
  size = "default",
  ...props
}: Omit<React.ComponentProps<"select">, "size"> & { size?: "sm" | "default" }): React.JSX.Element {
  return (
    <div
...
function NativeSelectOption({ ...props }: React.ComponentProps<"option">): React.JSX.Element {
